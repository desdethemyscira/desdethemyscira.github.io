...
<div class="section-wrap">
  ...
  <!-- ====== POST estilo párrafos: resúmenes divulgativos ampliados ====== -->
  <div class="post-list" aria-label="Resúmenes ampliados">
    <!-- 1 -->
    <div class="post-item">
      <h4>La descripción arquitectónica en la poesía bizantina temprana</h4>
      <div class="meta">Rodrigo Blum — Asesora: Dra. Martha Cecilia Jaime González</div>
      <p>Rodrigo analiza la llamada écfrasis en la poesía bizantina temprana, tomando el caso de Paulo el Silenciario frente a la monumental presencia de Hagia Sofía. Su estudio muestra cómo la descripción arquitectónica no solo informa una imagen visual, sino que construye sentidos sacros y colectivos —la iglesia se convierte en un texto vivo que narra creencias, memoria y estética ritual.</p>
    </div>

    <!-- 2 -->
    <div class="post-item">
      <h4>Ars metrica de José Jiménez. Edición, traducción y notas</h4>
      <div class="meta">María de Jesús Tinajero Díaz — Asesora: Dra. María Leticia López Serratos</div>
      <p>Este proyecto reúne una edición crítica del tratado métrico de José Jiménez, con traducción al español y notas que clarifican usos métricos y variantes textuales. La intención es ofrecer una herramienta didáctica y académica que revalore la tradición métrica hispana y su enseñanza.</p>
    </div>

    <!-- 3 -->
    <div class="post-item">
      <h4>Bíos Kaí Zoé: violencia, muerte y redención en el Orfismo</h4>
      <div class="meta">Santiago Campodonico — Asesora: Dra. Evelia Arteaga Conde</div>
      <p>Santiago reconstruye narrativas orficas donde la violencia ritual y el vínculo con la muerte operan como recursos simbólicos hacia una posible redención. El trabajo pone en diálogo fuentes fragmentarias y teorías religiosas para comprender cómo se articulaban promesas de vida posterior.</p>
    </div>

    <!-- 4 -->
    <div class="post-item">
      <h4>El círculo como medio de unicidad con lo divino</h4>
      <div class="meta">Efraín Ramírez Carrada — Asesora: Dra. Evelia Arteaga Conde</div>
      <p>Efraín propone una lectura simbólica del círculo como forma de unión con la divinidad: desde rituales hasta imágenes cosmológicas, el círculo opera como metáfora y práctica que procura integrar al sujeto con lo trascendente.</p>
    </div>

    <!-- 5 -->
    <div class="post-item">
      <h4>Los textos preliminares en el tratado Iuris Spiritualis Practicabilium Libri IV</h4>
      <div class="meta">Mayra Paola Aranda González — Asesora: Dra. Olivia Isidro Vázquez</div>
      <p>Mayra Paola examina prólogos, índices y elementos paratextuales del tratado para entender cómo se presentaba y legitimaba el saber jurídico-religioso en su contexto editorial e institucional.</p>
    </div>

    <!-- 6 -->
    <div class="post-item">
      <h4>Recepción del concepto de tonus en Aureliano Réome</h4>
      <div class="meta">Sergio Embleton Márquez — Asesora: Dra. María Leticia López Serratos</div>
      <p>Sergio explora cómo la noción de <em>tonus</em> —esa tensión que atraviesa sonido y cuerpo— aparece en la obra de Réome y en su recepción. La tesis vincula teoría musical, fisiología y experiencia estética para comprender la iteración histórica del término.</p>
    </div>

    <!-- 7 -->
    <div class="post-item">
      <h4>Safo en el borde: edición crítica digital a través de LaTeX y TEI</h4>
      <div class="meta">Alejandra González Jiménez — Asesora: Dra. Martha Cecilia Jaime González</div>
      <p>Alejandra desarrolla una edición crítica de Safo que combina el rigor tipográfico de LaTeX con el marcado interoperable de TEI, proponiendo una interfaz digital académica que preserve variantes y facilite la investigación colaborativa.</p>
    </div>

    <!-- 8 -->
    <div class="post-item">
      <h4>Religión, magia y ciencia: prolegomena del De magia universalis naturae et artis</h4>
      <div class="meta">Manuel de Jesús Islas Ramírez — Asesora: Dra. María Leticia López Serratos</div>
      <p>Manuel muestra cómo Schott y su contexto intelectual integran saberes religiosos, prácticas mágicas y proto-ciencia en un intento por ordenar el conocimiento de la naturaleza, subrayando continuidades entre esoterismo y ciencia temprana.</p>
    </div>

    <!-- 9 -->
    <div class="post-item">
      <h4>Medios, letras y crímenes de odio hacia la comunidad LGBT+</h4>
      <div class="meta">Marvin Gohan Leyva Cervantes — Asesoras: Dra. Evelia Arteaga Conde & Dra. Blanca Estela Pérez</div>
      <p>Marvin analiza cómo la prensa y la producción escrita contribuyen a la estigmatización y violencia simbólica contra la comunidad LGBT+, y propone formas de respuesta mediática y educativa para disminuir el impacto del discurso de odio.</p>
    </div>

    <!-- 10 -->
    <div class="post-item">
      <h4>La Conquista de México en De orbe novo decades</h4>
      <div class="meta">Michel Dolores Briseño — Asesor: Dr. Pedro Emilio Rivera Díaz</div>
      <p>Michel editó y tradujo pasajes clave de Pedro Mártir, aportando notas que contextualizan la mirada europea sobre la Conquista y facilitando su lectura crítica desde la historiografía contemporánea.</p>
    </div>

    <!-- 11 -->
    <div class="post-item">
      <h4>In muliere virum faciat opus est: Isotta Nogarola</h4>
      <div class="meta">Andrea Michel Hernández Romero — Asesora: Dra. Olivia Isidro Vázquez</div>
      <p>Andrea estudia la escritura epistolar de Isotta Nogarola para comprender cómo se negocian virtudes y roles de género en el Renacimiento, aportando una lectura que reivindica la agencia femenina en la esfera intelectual.</p>
    </div>

    <!-- 12 -->
    <div class="post-item">
      <h4>"Narraciones silenciosas de una tierra desconocida" — Libro de cuentos</h4>
      <div class="meta">Víctor Manuel Celaya Canto — Asesor: José Luis Gutiérrez Rocha</div>
      <p>Víctor presenta una colección narrativa que explora silencios, memoria y territorio, con relatos que combinan lo íntimo y lo geográfico en un ejercicio literario de re-descubrimiento.</p>
    </div>

    <!-- 13 -->
    <div class="post-item">
      <h4>Propuesta didáctica para la enseñanza de vocabulario médico en griego II</h4>
      <div class="meta">José Antonio Martínez Hernández — Asesora: Dra. Martha Cecilia Jaime González</div>
      <p>José Antonio elabora recursos y actividades para enseñar léxico médico en griego, pensando en estudiantes del Colegio de Ciencias y Humanidades: ejercicios activos, contexto clínico y materiales multimedia.</p>
    </div>

    <!-- 14 -->
    <div class="post-item">
      <h4>Visualidad y sonoridad en la écfrasis de la poesía tardoantigua</h4>
      <div class="meta">Yasmín Vera Torres — Asesora: Dra. Martha Cecilia Jaime González</div>
      <p>Yasmín estudia cómo las descripciones poéticas conjugan imagen y sonido para producir experiencias estéticas intensas; toma el episodio de Leandro como caso para analizar técnicas narrativas sensoriales.</p>
    </div>

    <!-- 15 -->
    <div class="post-item">
      <h4>La poesía épica de Virgilio para CCHeros</h4>
      <div class="meta">Ana Magdalena Aparicio Coraza — Asesora: Dra. Olivia Isidro Vázquez</div>
      <p>Ana Magdalena diseña una secuencia didáctica para acercar a estudiantes del CCH a Virgilio, usando actividades interpretativas que vinculan lectura, performance y reflexión sobre la épica.</p>
    </div>
