...
#signature:
---
<section style="background:#fdf3e6;padding:40px;font-family:serif;">
  ...
  <article style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:20px;transition:all 0.3s ease;cursor:pointer;"
    ...
    <img src="assets/images/testimonial/1asesion.png" 
  ...
  <article style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:20px;transition:all 0.3s ease;cursor:pointer;"
    ...
    <div style="padding:1.5rem;">
      ...
      <p style="color:#4a3f35;font-size:0.9rem;margin:0.2rem 0;"><strong>Asesora:</strong> Dra. María Leticia López Serratos</p>
      <p style="color:#7a4a2d;font-size:1rem;font-style:italic;margin:0.5rem 0;">
  ...
  <article style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:20px;transition:all 0.3s ease;cursor:pointer;"
    ...
    <div style="padding:1.5rem;">
      ...
      <p style="color:#4a3f35;font-size:0.9rem;margin:0.2rem 0;"><strong>Asesora:</strong> Dra. Evelia Arteaga Conde</p>
      <p style="color:#7a4a2d;font-size:1rem;font-style:italic;margin:0.5rem 0;">
  ...
  <article style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:20px;transition:all 0.3s ease;cursor:pointer;"
    ...
    <div style="padding:1.5rem;">
      ...
      <p style="color:#4a3f35;font-size:0.9rem;margin:0.2rem 0;"><strong>Asesora:</strong> Dra. Olivia Isidro Vázquez</p>
      <p style="color:#7a4a2d;font-size:1rem;font-style:italic;margin:0.5rem 0;">
  ...
  <article style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:20px;transition:all 0.3s ease;cursor:pointer;"
    ...
    <div style="padding:1.5rem;">
      ...
      <p style="color:#4a3f35;font-size:0.9rem;margin:0.2rem 0;"><strong>Asesoras:</strong> Dra. Evelia Arteaga Conde y Dra. Blanca Estela Pérez</p>
      <p style="color:#7a4a2d;font-size:1rem;font-style:italic;margin:0.5rem 0;">
  ...
  <article style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:20px;transition:all 0.3s ease;cursor:pointer;"
    ...
    <div style="padding:1.5rem;">
      ...
      <p style="color:#4a3f35;font-size:0.9rem;margin:0.2rem 0;"><strong>Asesor:</strong> Dr. Pedro Emilio Rivera Díaz</p>
      <p style="color:#7a4a2d;font-size:1rem;font-style:italic;margin:0.5rem 0;">
  ...
  <article style="background:#fff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);margin-bottom:20px;transition:all 0.3s ease;cursor:pointer;"
    ...
    <div style="padding:1.5rem;">
      ...
      <p style="color:#4a3f35;font-size:0.9rem;margin:0.2rem 0;"><strong>Asesor:</strong> José Luis Gutiérrez Rocha</p>
      <p style="color:#7a4a2d;font-size:1rem;font-style:italic;margin:0.5rem 0;">
